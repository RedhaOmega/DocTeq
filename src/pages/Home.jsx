...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6]">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-[#6D28D9] to-[#5B21B6] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6 animate-fade-in text-shadow-lg !text-red-400">
          ...
          <Link
            to="/appointment"
            className="inline-block bg-white text-[#6D28D9] px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-all transform hover:scale-105"
          >
            Prendre rendez-vous
          </Link>
        </div>
      ...
      <div className="max-w-7xl mx-auto py-16 px-4">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105">
            <FaCalendarCheck className="text-4xl text-[#6D28D9] mb-4" />
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105">
            <FaStethoscope className="text-4xl text-[#6D28D9] mb-4" />
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105">
            <FaClinicMedical className="text-4xl text-[#6D28D9] mb-4" />
      ...
      <div className="max-w-7xl mx-auto py-16 px-4">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="p-12">
              <h2 className="text-3xl font-bold text-[#6D28D9] mb-6">Une expérience patient repensée</h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-center">
                  <span className="bg-[#6D28D9] text-white rounded-full p-2 mr-3">✓</span>
      ...
      {/* Stats Section */}
      <div className="bg-[#6D28D9] text-white py-16">
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 text-center">
        ...
        <div className="flex justify-center gap-4">
          <Link
            to="/signup"
            className="bg-[#6D28D9] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#5B21B6] transition-all transform hover:scale-105"
          >
            Créer un compte
          </Link>
        </div>
